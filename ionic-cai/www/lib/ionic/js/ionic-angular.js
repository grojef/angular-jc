 ...
 * @usage
 * ```js
 * var ionic-aicai = angular.module('reallyCoolApp', ['ionic']);
 *
 * ionic-aicai.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('ionic-aicai', ['ionic'])
 ...
 *
 * ```js
 *   angular.module('ionic-aicai', ['ionic'])
